...
import { FormControl, FormControlLabel, FormLabel, PaletteMode, Radio, RadioGroup, Switch, useMediaQuery } from '@mui/material';
    ...
    <SubCard title="Layout">
      ...
      {layout === LAYOUT_CONST.VERTICAL_LAYOUT && !matchDownMD && (
        <FormControl component="fieldset" sx={{ mt: 2 }}>
          ...
          <RadioGroup aria-label="drawer" value={drawerType} onChange={e => onChangeDrawer(e.target.value)} name="row-radio-buttons-group">
            <FormControlLabel
              value="default"
              control={<Radio />}
              label="Default"
