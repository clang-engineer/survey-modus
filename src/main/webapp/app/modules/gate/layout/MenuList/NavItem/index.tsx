...
import VerticalNavItem from 'app/modules/gate/layout/MenuList/NavItem/vertical-nav-item';
import HorizontalNavItem from 'app/modules/gate/layout/MenuList/NavItem/horizontal-nav-item';
