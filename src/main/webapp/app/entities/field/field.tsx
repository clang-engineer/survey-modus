      ...
      <Box id="field-heading" data-cy="FieldHeading">
        <Box display="flex" justifyContent="flex-end" alignItems="center">
          <Button className="me-2" variant="contained" color="secondary" size="small" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="exformmakerApp.field.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Button
            variant="contained"
            color="primary"
          ...
          >
            ...
            <Translate contentKey="exformmakerApp.field.home.createLabel">Create new Field</Translate>
          </Button>
        </Box>
      </Box>
      {fieldList && fieldList.length > 0 ? (
          ...
          <TableHead>
            <TableRow>
              <TableCell className="hand" onClick={sort('id')}>
                <Translate contentKey="exformmakerApp.field.id">ID</Translate>
        ...
        !loading && (
          <div className="alert alert-warning">
            <Translate contentKey="exformmakerApp.field.home.notFound">No Fields found</Translate>
          </div>
        )
      )}
      {totalItems ? (
