...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERPOINT_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERPOINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERPOINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERPOINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERPOINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERPOINT actions', async () => {
      const expectedActions = [
        {
